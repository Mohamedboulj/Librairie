...
<body>
  ...
  <div class="container shadow mt-3 w-50 py-4">
    ...
    <?php
    if (isset($error)) {
      echo "<div  class='alert alert-danger info'>", $error, "" . count($book->errorMsg) . "</div>";
    }
    if (isset($success)) {
    ...
    <form action="" method="post">
      <div class="mb-3">
        ...
        <input class="form-control" id="title" type="text" name="title" placeholder="Enter book title" />
      </div>
      <?php
      ...
      <div class="mb-3">
        ...
        <input class="form-control" id="author" type="text" name="author" placeholder="Enter book author" />
      </div>
      <?php
      ...
      <div class="mb-3">
        ...
        <input class="form-control" id="dp" type="text" name="dp" placeholder="Enter date of publication" />
      </div>
      <?php
      ...
      <div class="d-grid">
        <button class="btn btn-primary btn-lg" value="submit" name="submit" type="submit">Add</button>
      </div>
